...
wordcloud(corpus, scale=c(6,.5), min.freq=3, max.words=200, random.order=TRUE,
...
```{r histograms}
barplot(twogramfreq[2:26,2], 
        names.arg=twogramfreq[2:26,1], 
        col = "blue", 
        main="Twograms (Top 25)", 
        las=2, 
        ylab = "Frequency")

barplot(threegramfreq[1:25,2], 
        names.arg=threegramfreq[1:25,1], 
        col = "red", 
        main="Threegrams (Top 25)", 
        las=2, 
        ylab = "Frequency")
```
